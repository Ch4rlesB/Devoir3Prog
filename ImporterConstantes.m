% Chemins vers les fichiers principaux du projet
CHEMIN_DONNEES = '.\Donnees';
CHEMIN_RAPPORTS = '.\Rapports';
CHEMIN_MODULES = '.\Modules';

% Chemmins vers les modules
CHEMIN_MOD_CLIENT = [CHEMIN_MODULES, '\ModuleClient'];
CHEMIN_MOD_PLATEFORME = [CHEMIN_MODULES, '\ModulePlateforme'];
